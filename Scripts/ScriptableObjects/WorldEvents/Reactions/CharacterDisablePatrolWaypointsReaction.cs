...
{
    public class CharacterDisablePatrolWaypointsReaction : CharacterRemoteControlReaction
    {
        public override IEnumerator React()
        {
            base.Initialize();

            if (Character.StartRemoteControlAction(new DisablePatrolWaypoints_RCA()))
            {
